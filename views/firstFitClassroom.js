function loadAPI() {
    ...
    function schedulerName(response) {
        ...
        $(document).ready(function () {
            ...
            $('#textContent').text("First Fit (primeiro encaixe) que percorre a fila até encontrar o primeiro espaço em que caiba todo o processo. É um algoritmo bem rápido!")
        })
        switch (response) {
            case 'First Fit':
