function loadAPI() {
    ...
    function schedulerName(response) {
        ...
        $(document).ready(function () {
            ...
            $('#textContent').text("Next Fit (primeiro encaixe), possui o mesmo algoritmo que o First Fit, só que ao invés de procurar sempre a partir do início da lista, procura a partir do último ponto em que encontrou. O seu desempenho é parecido com o do First Fit!")
        })
        switch (response) {
            case 'Next Fit':
