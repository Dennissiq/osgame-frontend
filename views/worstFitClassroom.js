function loadAPI() {
    ...
    function schedulerName(response) {
        ...
        $(document).ready(function () {
            ...
            $('#textContent').text("Worst Fit (pior ajuste), pega sempre o maior buraco disponível. Desempenho ruim!")
        })
        switch (response) {
            case 'Worst Fit':
                function animationWorstFit() {
                    if (response == 'Worst Fit') {
                    ...
                    tl.from([$title, $subtitle, $textTime], 0.7, { x: '150', y: '-40', autoAlpha: 0, ease: Power4.easeInOut })
                      ...
                      .to  ($box2, 0.5, { x: '100',  autoAlpha: 1, ease: Power4.easeInOut  })
                      .to  ($box2, 0.5, { x: '145',  autoAlpha: 1, ease: Bounce.easeOut })
                      .to  ($box2, 0.5, { y: '-87',  autoAlpha: 1, ease: Power4.easeInOut })
